...
<div id="grid" class="container gap-above">
    <div class="row">
        <div class="col-md-9 main">
            <h1>Debashish Chowdhury</h1>
            <img src="<?=PUBLIC_URL?>images/stock/Debashish_Chowdhury.jpg" class="profile-thumb" alt="Debashish Chowdhury" />
            <p class="affiliation">
                IIT, Kanpur
            </p>
            <p>
                <strong>Debashish Chowdhury</strong> received PhD from IIT Kanpur in 1984. After postdoctoral research in Germany and USA, he served as a faculty member for 5 years in JNU, New Delhi, before joining IIT Kanpur in 1992. He became Professor in 1997. He was the Dr Jag Mohan Garg Chair Professor at IIT Kanpur (2011–2014). At present, he is the S. Sampath Chair Professor and Head of the Department of Physics. He is a Fellow of all the three Indian National Science Academies (IASc in 2004). He is a recipient of the Alexander von Humboldt Fellowship, INSA Young Scientist Medal and J C Bose National Fellowship. His area of research is statistical and biological physics.
            </p>
            ...
            <div class="talk">
                ...
                <span class="presentation"><a target="_blank" title="Click here to see the presentation" href="<?=PUBLIC_URL?>pdf/15_DebashishChowdhury.pdf"><i class="fa fa-paperclip"></i> View Presentation</a>&nbsp; / &nbsp; <a target="_blank" title="Click here to see the presentation" href="https://www.youtube.com/watch?v=IbFPUWwLRcU&list=PLXkPBNeac4NyxmjRLxPOu2q4TuABXHnAE&index=12"><i class="fa fa-paperclip"></i> View Video</a>
                </span>    
                </p>
                <p class="abstract">
