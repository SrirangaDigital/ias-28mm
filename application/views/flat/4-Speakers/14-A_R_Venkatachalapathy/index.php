...
<div id="grid" class="container gap-above">
    <div class="row">
        <div class="col-md-9 main">
            <h1>A R Venkatachalapathy</h1>
            <img src="<?=PUBLIC_URL?>images/stock/A_R_Venkatachalapathy.jpg" class="profile-thumb" alt="A R Venkatachalapathy" />
            <p class="affiliation">
                Madras Institute of Developmental Studies, Chennai
            </p>
            <p>
                <strong>A R Venkatachalapathy</strong> is Professor at the Madras Institute of Development Studies, Chennai. He has taught at universities at Tirunelveli, Chennai and Chicago, and was the ICCR Chair Professor at the National University of Singapore. He has published widely on the social, cultural and intellectual history of colonial Tamil Nadu. An accomplished writer in Tamil, Venkatachalapathy has authored and edited over 20 books in Tamil. His publications include <i>The Province of the Book: Scholars, Scribes and Scribblers in Colonial Tamil Nadu; In Those Days There Was No Coffee: Writings in Cultural History;</i> and (as editor) <i>Love Stands Alone: Selections from Tamil Sangam Poetry</i>.
            </p>
