...
<div id="grid" class="container gap-above">
    <div class="row">
        <div class="col-md-9 main">
            <h1>Sumathi Rao</h1>
            <img src="<?=PUBLIC_URL?>images/stock/Sumathi_Rao.jpg" class="profile-thumb" alt="Sumathi Rao" />
            <p class="affiliation">
                Harish-Chandra Research Institute, Allahabad
            </p>
            <p><strong>Sumathi Rao</strong> received her PhD from the State University of New York at Stony Brook in 1983 in particle physics. She joined the Institute of Physics in Bhubaneswar in 1987, after postdoctoral jobs at Fermi Lab and at the University of Wisconsin in Madison. She is currently a Professor at the Harish-Chandra Research Institute in Allahabad, where she and her students work in the area of condensed matter systems. She was elected Fellow of the National Academy of Sciences, India, in 2001 and Fellow of the Indian Academy of Sciences in 2017.</p>

            <div class="talk">
                <p class="type">Session 1B: Inaugural Lectures by Fellows/Associates</p>
                <p class="title">Topological phases of quantum matter
                <span class="presentation"><a target="_blank" title="Click here to see the presentation" href="<?=PUBLIC_URL?>pdf/3_SumathiRao.pdf"><i class="fa fa-paperclip"></i> View Presentation</a>&nbsp; / &nbsp; <a target="_blank" title="Click here to see the presentation" href="https://www.youtube.com/watch?v=L15ICCGtZKA&index=2&list=PLXkPBNeac4NyxmjRLxPOu2q4TuABXHnAE"><i class="fa fa-paperclip"></i> View Video</a>
                </span>
                </p>
                <p class="abstract">
