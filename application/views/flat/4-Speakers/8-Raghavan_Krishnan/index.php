    ...
    <div class="row">
        <div class="col-md-9 main">
            ...
            <div class="talk">
                ...
                <span class="presentation"><a target="_blank" title="Click here to see the presentation" href="<?=PUBLIC_URL?>pdf/8_RaghavanKrishnan.pdf"><i class="fa fa-paperclip"></i> View Presentation</a>&nbsp; / &nbsp;
                <a target="_blank" title="Click here to see the presentation" href="https://www.youtube.com/watch?v=NnuS09KnbaI&list=PLXkPBNeac4NyxmjRLxPOu2q4TuABXHnAE&index=6"><i class="fa fa-paperclip"></i> View Video</a>    
                </span></p>
                <p class="abstract">
