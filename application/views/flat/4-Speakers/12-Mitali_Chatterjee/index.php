    ...
    <div class="row">
        <div class="col-md-9 main">
            ...
            <div class="talk">
                ...
                <span class="presentation"><a target="_blank" title="Click here to see the presentation" href="<?=PUBLIC_URL?>pdf/12_Mitali_Chatterjee.pdf"><i class="fa fa-paperclip"></i> View Presentation</a></span></p>
                <p class="abstract">
